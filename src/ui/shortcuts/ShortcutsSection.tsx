  ...
  return (
    <section className="flex flex-col gap-1 p-4">
      ...
      <p className="text-xs text-muted-foreground">
        Press Add and type a combination to bind it; an action can have several. Remove the × on a
        binding to drop it (removing the last one disables the action). Escape cancels recording, so it
        cannot be assigned.
      </p>
