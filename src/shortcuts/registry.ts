...
export const SHORTCUT_ACTIONS: readonly ShortcutAction[] = [
  ...
  },
  {
    id: 'cycle-view',
    name: 'Cycle view',
    description: 'Move to the next options view: Rules, Cookie sync, Shortcuts.',
  ...
  },
  {
    id: 'new-item',
    name: 'New item',
    description: 'Create a new rule in the Rules view or a new mapping in the Cookie sync view.',
  ...
  },
  {
    ...
    description: 'Move focus and selection to the previous visible sidebar row.',
  ...
  },
  {
    ...
    description: 'Expand a collapsed folder, or move focus to its first child if open.',
    defaultHotkey: 'ArrowRight',
  },
  {
    id: 'tree-collapse',
    name: 'Tree: collapse / to parent',
    description: 'Collapse an expanded folder, or move focus to the parent folder.',
  ...
  },
  {
    ...
    description: 'Move the focused node into the immediately-preceding sibling folder.',
