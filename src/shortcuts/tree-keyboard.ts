...
export const expandedFolderIds = (tree: TreeNode[]): Set<string> =>
  kb.expandedFolderIds(tree);

export const flattenSelectable = (
  tree: TreeNode[],
  expandedIds: Set<string>,
): string[] => kb.flattenSelectable(tree, expandedIds);

export const treeMoveTarget = (
  tree: TreeNode[],
  id: string,
  direction: TreeMoveDirection,
): MoveTarget | null => kb.treeMoveTarget(tree, id, direction);
